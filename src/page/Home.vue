    ...
    <div class="header-div disFlex">
      <el-tooltip class="item" effect="light" content="返回首页" placement="right">
        <div class="header-div-left disFlex" @click="gohome()">
          <span style="margin-left: 10px;font-weight: bold;font-size: 20px">Warehouse</span>
        </div>
      </el-tooltip>
...
<script>
  ...
  export default {
    ...
    created: function () {
      ...
      this.menuList = [
        {
          menuName: "Operation", isOpen: 0,
          adminMenuList: [
            {menuName: "NormalQuery", isOpen: 0, path: "/articleManage"},
            {menuName: "view", isOpen: 0, path: "/view"}
          ]
        },
        
        {
          menuName: "Mysql", isOpen: 0,
          adminMenuList: [
            {menuName: "show", isOpen: 0, path: "/user"}
          ]
        }
      ];
      this.userName = "Tom";
